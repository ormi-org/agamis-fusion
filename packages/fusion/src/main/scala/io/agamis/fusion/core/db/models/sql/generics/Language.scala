...
import io.agamis.fusion.core.db.models.sql.generics.exceptions.languages.MalformedLocalLanguageCodeException
...
class Language {
    ...
    /** A method for setting locale language code (LCID) property
      ...
      * @throws MalformedLocalLanguageCodeException when provided code is not matching regex test
      * @return this object
      */
