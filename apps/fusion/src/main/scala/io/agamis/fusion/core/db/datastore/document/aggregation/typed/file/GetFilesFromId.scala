...
object GetFilesFromId extends PipelineWrapper {
    ...
    class GetFilesFromIdPipeline(protected val _collection: BSONCollection)
        extends Pipeline {
    ...
    override def pipeline(col: BSONCollection): GetFilesFromIdPipeline =
        new GetFilesFromIdPipeline(col)
}
