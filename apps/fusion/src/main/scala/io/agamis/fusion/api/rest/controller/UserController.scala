...
//     import io.agamis.fusion.core.actor.data.entities.UserDataBehavior.MultiUserState
//     import io.agamis.fusion.core.actor.data.entities.UserDataBehavior.SingleUserState
