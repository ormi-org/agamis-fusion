...
import io.agamis.fusion.external.http.entities.{User, UserJsonProtocol}
import io.agamis.fusion.external.http.actors.AuthenticationRepository
import akka.http.scaladsl.model.HttpResponse
import akka.http.scaladsl.model.headers.RawHeader
import io.agamis.fusion.external.http.actors.UserRepository
...
class AuthenticationRoutes(buildAuthenticationRepository: ActorRef[AuthenticationRepository.Command])(implicit system: ActorSystem[_]) extends UserJsonProtocol {
    ...
    import io.agamis.fusion.external.http.authorization.JwtAuthorization._
