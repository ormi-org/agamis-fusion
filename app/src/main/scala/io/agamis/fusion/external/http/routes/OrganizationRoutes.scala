...
import io.agamis.fusion.external.http.entities.{Organization, OrganizationJsonProtocol}
import io.agamis.fusion.external.http.actors.OrganizationRepository
