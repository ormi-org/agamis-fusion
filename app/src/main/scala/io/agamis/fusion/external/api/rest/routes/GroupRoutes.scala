...
import io.agamis.fusion.external.api.rest.dto.group.{GroupDto, GroupJsonSupport}
...
/**
  ...
  * @param system
  */
class GroupRoutes(buildGroupRepository: ActorRef[GroupRepository.Command])(implicit system: ActorSystem[_]) extends GroupJsonSupport {
