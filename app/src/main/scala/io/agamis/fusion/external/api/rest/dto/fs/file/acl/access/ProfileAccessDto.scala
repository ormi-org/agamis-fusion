package io.agamis.fusion.external.api.rest.dto.fs.file.acl.access

import io.agamis.fusion.core.db.models.documents.file.acl.access.ProfileAccess
import io.agamis.fusion.external.api.rest.dto.fs.file.acl.access.rights.RightsDto
import io.agamis.fusion.external.api.rest.dto.fs.file.acl.access.rights.RightsDtoJsonProtocol._
import spray.json._
